<template>
  ...
  <div class="container">
    ...
    <div class="float-child">
      <!-- <RecipePreviewList title="Explore this Recipes" :recipes="randomRecipes" :isPreview="true" :show_ing_and_serv="false" /> -->
    </div>
    ...
    <div class="float-child">
      <!-- <RecipePreviewList v-if="this.$root.store.username" title="Last Watched Recipes" :recipes="lastViewedRecipes" :isPreview="true" :show_ing_and_serv="false" disabled /> -->
    </div>
